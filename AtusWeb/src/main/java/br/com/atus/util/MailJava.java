...
public class MailJava implements Serializable {
    ...
    public MailJava(String smtpHostMail, String smtpPortMail, String smtpAuth, String smtpStarttls, String fromNameMail, String userMail, String passMail, String subjectMail, String bodyMail, Map<String, String> toMailsUsers, String charsetMail, String typeTextMail) {
